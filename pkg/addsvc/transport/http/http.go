...
func NewHTTPHandler(endpoints addtransport.Set, logger log.Logger) http.Handler {
...
func NewHTTPClient(instance string, otTracer stdopentracing.Tracer, zipkinTracer *stdzipkin.Tracer, logger log.Logger) (addsvc.Service, error) {
...
func err2code(err error) int {
	switch err {
	case implementation.ErrTwoZeroes, implementation.ErrMaxSizeExceeded, implementation.ErrIntOverflow:
...
func decodeHTTPSumRequest(_ context.Context, r *http.Request) (interface{}, error) {
	var req addtransport.SumRequest
...
func decodeHTTPConcatRequest(_ context.Context, r *http.Request) (interface{}, error) {
	var req addtransport.ConcatRequest
	err := json.NewDecoder(r.Body).Decode(&req)
	return req, err
}
...
func decodeHTTPSumResponse(_ context.Context, r *http.Response) (interface{}, error) {
	...
	var resp addtransport.SumResponse
...
func decodeHTTPConcatResponse(_ context.Context, r *http.Response) (interface{}, error) {
	...
	var resp addtransport.ConcatResponse
	err := json.NewDecoder(r.Body).Decode(&resp)
	return resp, err
}
