...
import (
	...
	http "github.com/jwenz723/logwrapper/pkg/http"
...
var fs = flag.NewFlagSet("logwrapper", flag.ExitOnError)
...
func Run() {
	...
	if *zipkinURL != "" {
		...
		recorder := zipkingoopentracing.NewRecorder(collector, false, "localhost:80", "logwrapper")
